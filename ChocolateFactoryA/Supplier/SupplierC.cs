...
namespace ChocolateFactoryA
{
    class SupplierC : ISupplier
    {
        ...
        public SupplierC(Random random)
        {          
        ...
        public IRawMaterialsOffer GiveΟfferRawMaterials(ISupplier supplier, Random random)
        {
            try
            {
                IRawMaterialsOffer rawMaterialsOffer = new RawMaterialsOfferC(random);
        ...
        public void S_MakeTransaction(SupplierC supplierC, double cost)
        {
            supplierC.S_Wallet.MakeTransaction(supplierC.S_Wallet, cost);
        }
    }
}
